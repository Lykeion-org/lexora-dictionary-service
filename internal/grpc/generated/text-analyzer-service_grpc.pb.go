...
const (
	AnalysisService_AnalyzeText_FullMethodName = "/lexora.AnalysisService/AnalyzeText"
)
...
type AnalysisServiceClient interface {
	AnalyzeText(ctx context.Context, in *AnalyzeTextRequestTA, opts ...grpc.CallOption) (*AnalyzeTextResponseTA, error)
}
...
func (c *analysisServiceClient) AnalyzeText(ctx context.Context, in *AnalyzeTextRequestTA, opts ...grpc.CallOption) (*AnalyzeTextResponseTA, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AnalyzeTextResponseTA)
...
type AnalysisServiceServer interface {
	AnalyzeText(context.Context, *AnalyzeTextRequestTA) (*AnalyzeTextResponseTA, error)
...
func (UnimplementedAnalysisServiceServer) AnalyzeText(context.Context, *AnalyzeTextRequestTA) (*AnalyzeTextResponseTA, error) {
...
func _AnalysisService_AnalyzeText_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalysisServiceServer).AnalyzeText(ctx, req.(*AnalyzeTextRequestTA))
	}
...
var AnalysisService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "lexora.AnalysisService",
	...
	Metadata: "text-analyzer-service.proto",
}
